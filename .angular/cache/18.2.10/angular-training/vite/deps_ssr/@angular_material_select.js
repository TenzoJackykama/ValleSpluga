...
var MatSelect = class _MatSelect extends _MatSelectMixinBase {
  ...
  constructor(_viewportRuler, _changeDetectorRef, _ngZone, _defaultErrorStateMatcher, elementRef, _dir, _parentForm, _parentFormGroup, _parentFormField, ngControl, tabIndex, scrollStrategyFactory, _liveAnnouncer, _defaultOptions) {
    ...
    this.optionSelectionChanges = (0, import_rxjs4.defer)(() => {
      ...
      return this._ngZone.onStable.pipe((0, import_operators3.take)(1), (0, import_operators3.switchMap)(() => this.optionSelectionChanges));
    });
